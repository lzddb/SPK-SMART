            ...
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" class="btn btn-warning btn-sm mr-1" data-bs-toggle="modal" data-bs-target="#updateAlternatif-{{ $item->id }}"> <i class="fas fa-pen"></i>
                            </a>
                            <a href="{{ route('delete-alternatif', $item->id) }}" class="btn btn-danger btn-sm mr-1">
...
<div class="modal fade" id="updateAlternatif-{{ $item->id }}" tabindex="-1" aria-labelledby="UpdateAlternatifModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('update-alternatif', $item->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="alternatif" class="form-label">Alternatif</label>
                        <input type="text" value="{{ $item->alternatif }}" class="form-control" name="alternatif">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
