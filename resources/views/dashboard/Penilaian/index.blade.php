            ...
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" class="btn btn-warning btn-sm mr-1" data-bs-toggle="modal" data-bs-target="#Penilaian-{{ $item->id }}"> <i class="fas fa-pen"></i>
                            </a>
                        </td>
                    </tr>
                    @empty
...
<div class="modal fade" id="Penilaian-{{ $item->id }}" tabindex="-1" aria-labelledby="PenilaianModalLabel" aria-hidden="true">
            ...
            <form action="{{ route('tambah-penilaian') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="" value="{{ $item->alternatif }}" readonly>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_sub[]" class="form-select" aria-label="Default select example">
                            <option selected>Silahkan Pilih Sub Kriteria {{ $c->kriteria }}</option>
                            @foreach ($subKriteria as $sc)
