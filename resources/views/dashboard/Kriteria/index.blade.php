            ...
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" class="btn btn-warning btn-sm mr-1" data-bs-toggle="modal" data-bs-target="#updateKriteria-{{ $c->id }}"> <i class="fas fa-pen"></i>
                            </a>
                            <a href="{{ route('delete-kriteria', $c->id) }}" class="btn btn-danger btn-sm mr-1"> <i class="fas fa-trash"></i>
                            </a>
                        </td>
                    </tr>
                    @empty
...
<div class="modal fade" id="updateKriteria-{{ $item->id }}" tabindex="-1" aria-labelledby="UpdateKriteriaModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('update-kriteria', $item->id) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="kode_kriteria" class="form-label">Kode Kriteria</label>
                        <input type="text" value="{{ $item->kode_kriteria }}" class="form-control" name="kode_kriteria">
                    </div>
                    <div class="mb-3">
                        <label for="kriteria" class="form-label">Kriteria</label>
                    ...
                    <div class="mb-3">
                        <label for="jenis" class="form-label">Jenis Kriteria</label>
                        <select name="jenis" value="{{ $item->jenis }}" class="form-select" aria-label="Default select example">
                    ...
                    <div class="mb-3">
                        <label for="bobot_kriteria" class="form-label">Bobot</label>
                        <input type="number" value="{{ $item->bobot_kriteria }}" class="form-control" name="bobot_kriteria">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
